...
export type FilterValues = {
  ...
  filterValueMinWeight?: number;
  filterValueMaxWeight?: number;
  filterValueMinDistance?: number;
  filterValueMaxDistance?: number;
  ...
  filterValueMinNumScheduleDays?: number;
  filterValueMaxNumScheduleDays?: number;
  filterValueWeightUnits?: Set<string>;
  filterValueDistanceUnits?: Set<string>;
  filterValueMultisetTypes?: Set<string>;
  filterValueMinBodyFatPercentage?: number;
  filterValueMaxBodyFatPercentage?: number;
...
export type TimePeriodFilterValues = {
  ...
  filterValueMinDuration?: number;
  filterValueMaxDuration?: number;
