          ...
          <>
            <div className="flex flex-col gap-1 w-full">
              {userWeights.map((userWeight) => (
                <div
                  className="flex justify-between items-center gap-1 bg-default-100 border-2 border-default-200 rounded-xl px-2 py-1 hover:border-default-400 focus:bg-default-200 focus:border-default-400"
                  key={userWeight.id}
                >
