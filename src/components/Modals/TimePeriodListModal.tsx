...
export const TimePeriodListModal = ({
  timePeriodListModal,
  useTimePeriodList,
  ...
  return (
    <Modal
      isOpen={timePeriodListModal.isOpen}
      onOpenChange={timePeriodListModal.onOpenChange}
    >
      <ModalContent>
        {(onClose) => (
          <>
            <ModalHeader>Select Time Period</ModalHeader>
            <ModalBody>
