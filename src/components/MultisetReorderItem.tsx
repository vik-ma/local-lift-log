        ...
        <div className="flex justify-between gap-1 items-center w-full max-w-[19rem]">
          ...
          <div className="flex justify-between items-center gap-1">
            ...
            {setNum && (
              <motion.div
                ref={setNumDragRef}
                className={`w-[4rem] text-center py-0.5 select-none text-secondary bg-stone-100 rounded-lg hover:bg-stone-200 hover:text-stone-600 active:bg-stone-200 active:text-stone-600 ${
